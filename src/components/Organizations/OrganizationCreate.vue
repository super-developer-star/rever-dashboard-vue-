                ...
                <form v-on:submit="formSubmit()">
                  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input v-model="organization.name" required name="name" id="name" type="text" class="form-control clear-border-radius" placeholder="" />
...
export default {
  ...
  methods: {
    ...
    formSubmit: function (e) {
      ...
      api.Organization.create(token, data)
      .then((response) => {
        this.$router.push('/organizations')
        this.showAlert('success', 'Organization ' + response.data.name + ' saved')
      })
      .catch((err) => {
